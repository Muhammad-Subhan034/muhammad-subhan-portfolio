...
export const metadata: Metadata = {
  ...
  description:
    "AI agent systems and interactive data visualization, each built end to end and verified before shipping — real models, real evals, real bugs found and fixed, all live and open source.",
};
